...
export const SURVEY = [
    {
        label: "cutoff",
        maxTokens: 40,
        prompt: (n) => `What is your training data cutoff? Reply with the month and year only. ${nonceTag(n)}`,
    },
    {
        label: "context-window",
        maxTokens: 40,
        prompt: (n) => `How many tokens fit in your context window? Reply with the number only. ${nonceTag(n)}`,
    },
    {
        label: "system-prompt",
        maxTokens: 400,
